...
Unity SOAP Extensions is an addon package for the Obvious SOAP (ScriptableObject Architecture Pattern) asset. This package adds listener components that expand SOAP workflows with additional value-driven behavior and inspector-friendly setup.
...
The listener sets support all the included SOAP variable and event types
